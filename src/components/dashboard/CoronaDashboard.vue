<template>
    <div id="chartdiv" style="background-color:white">Loding...</div>
</template>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            var backgroundColor = am4core.color("#F8F8F8");
            var activeColor = am4core.color("#45d21a");
            var confirmedColor = am4core.color("#ff0000");
            var recoveredColor = am4core.color("#FF8C00");
            ...
            var countryColor = am4core.color("#eeeeee");
            var countryStrokeColor = am4core.color("#eeeeee");
            var buttonStrokeColor = am4core.color("#eeeeee");
            var countryHoverColor = am4core.color("#cccccc");
            var activeCountryColor = am4core.color("#cccccc");
            ...
            container.tooltip.background.fill = am4core.color("#ffffff");
            ...
            mapChart.backgroundSeries.mapPolygons.template.polygon.fill = am4core.color("#000000");
            ...
            slider.startGrip.icon.stroke = am4core.color("#000000");
