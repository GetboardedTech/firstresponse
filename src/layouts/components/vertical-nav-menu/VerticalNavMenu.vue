<!-- =========================================================================================
  ...
  ----------------------------------------------------------------------------------------
  Item Name: VuexyVuexy - Vuejs, HTML & Laravel Admin Dashboard Template
    Author: Pixinvent
...
<!--             <img src="@/assets/images/logo/health.gif" alt="Logo" class="w-10 mr-4 fill-current text-primary" style="height: 40px;width: 40px;">-->
